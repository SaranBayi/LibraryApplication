			...
			<div class="hero-text">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						%>
						<form action="SignUpImp" method="get">
							<table class="table">
								<tbody style="text-align: left: font-style: left;">
									...
									<tr>
										<td style="color:white"><input type="radio" id="radioLib" name="radioLib"
											value="librarian">Librarian &nbsp;&nbsp;<input
											type="radio" id="radioUser" name="radioUser" value="user">User</td>
									</tr>
