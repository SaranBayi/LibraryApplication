	...
	<div class="hero-image">
		<div class="hero-text">
			...
			<div class="container">
				...
				<h2 class="text-center" style="color:white">Books List</h2>
					...
					<tbody>
						<c:forEach items="${books}" var="book">
							<tr class="success">
								...
								<td><a
									href="UserOperator?action=add&id=<c:out value="${book.id}"/>"><button
											type="button" class="btn btn-success">Add to Cart</button></a></td>
